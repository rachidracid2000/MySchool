...
export default function AdminLoginScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <Image
          source={require('assets/images/image enseignant.png')} // image silhouette
          style={styles.avatar}
        />
      </ImageBackground>
      ...
      <View style={styles.form}>
        <Text style={styles.subtitle}>Connectez-vous à votre espace enseignant</Text>
    ...
    if (email=="" && password=="") {
      router.push('/src/Firstpage/Enseignant/espaceenseignant'); // Change ça vers ton écran cible
    } else {

...
import {
  View, Text, StyleSheet, Image, TouchableOpacity,ImageBackground, ScrollView,Modal,
  Alert, } from "react-native";
import SelectionClasseModal from './class'; // ← bien importé
import SelectionClasseAbsenceModal from './classabsence';
import SelectionClassremarqueModal from './classremarque';

import { MaterialIcons } from "@expo/vector-icons";
const roles = [
  { label: "annonces", image: require("assets/images/annonce.png") },
  { label: "notes", image: require("assets/images/note.png") },
  { label: "edt", image: require("assets/images/ddt.png") },
  { label: "remarques", image: require("assets/images/remarque.png") },
  { label: "absences", image: require("assets/images/abcence.png") },
  { label: "documents", image: require("assets/images/document.png") },
];
...
const [remarqueVisible, setremarqueVisible] = useState(false);
  ...
  const handleRolePress = (roleLabel: string) => {
    switch (roleLabel.toLowerCase()) {
      ...
      case "notes":
        ...
        break;
      case "edt":
        router.push("/src/Firstpage/Enseignant/edtensiegnant");
        break;
      case "remarques":
      ...
      case "absences":
        ...
        break;
      case "documents":
        router.push("/src/Firstpage/Enseignant/document");
        break;
      default:
        break;
    }
  ...
  const handleProfile = () => {
     router.push("/src/Firstpage/Enseignant/profilenseignant");
...
<SelectionClasseModal visible={noteVisible} onClose={() => setNoteVisible(false)} />
<SelectionClasseAbsenceModal visible={absenceVisible} onClose={() => setAbsenceVisible(false)} />
<SelectionClassremarqueModal visible={remarqueVisible} onClose={() => setremarqueVisible(false)} />
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={() => router.push('/src/Firstpage/Enseignant/notificationensignant')}>
      ...
      <ImageBackground
        ...
        style={{ height: 189 }}
      >
        <Text style={styles.text}>Espace Enseignant</Text>
      </ImageBackground>

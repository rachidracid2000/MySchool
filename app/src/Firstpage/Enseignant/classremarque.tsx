...
const SelectionClassremarqueModal = ({ visible, onClose }: Props) => {
  const router = useRouter();

  const handleSelect = (classe: string) => {
    onClose(); // ferme le modal
    router.push('/src/Firstpage/Enseignant/romarque'); // redirige
  };
...
export default SelectionClassremarqueModal;

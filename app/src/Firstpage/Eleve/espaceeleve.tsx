...
const first = () => {
  ...
  const handleRolePress = (roleLabel: string) => {
    switch (roleLabel.toLowerCase()) {
      case "annonces":
        ...
        break;
      case "notes":
        router.push("/src/Firstpage/Eleve/note");
        break;
      case "edt":
        router.push("/src/Firstpage/Eleve/edt");
        break;
      case "documents":
        router.push("/src/Firstpage/Eleve/document");
        break;
      default:
        break;
    }
  ...
  const handleProfile = () => {
     router.push("/src/Firstpage/Eleve/profileleve");
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.header}>
        <TouchableOpacity  onPress={() => router.push('/')}>
          ...
          <Image source={require("assets/images/image copy.png")} style={styles.bellIcon1} />
          </Text>
        </TouchableOpacity>
        <Text style={styles.appTitle}>MySchool</Text>
      <TouchableOpacity onPress={() => router.push('/src/Firstpage/Eleve/notificationeleve')}>
             <Image source={require("assets/images/image.png")} style={styles.bellIcon} />
             </TouchableOpacity>
             <TouchableOpacity  onPress={() => setMenuVisible(true)}>
     
             <Image source={require("assets/images/image 3point.png")} style={styles.bellIcon1} />
             </TouchableOpacity>
      </View>
      ...
      <ImageBackground
        ...
        style={{ height: 189 }}
      >
        <Text style={styles.text}>Espace Élève</Text>
      </ImageBackground>

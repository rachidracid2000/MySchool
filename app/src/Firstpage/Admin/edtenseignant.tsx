...
export default function EmploiTempsAdmin() {
  ...
  return (
    <ScrollView contentContainerStyle={{ padding: 16 }}>
      ...
      <Text>Sélectionner une Enseignant :</Text>
      <Picker selectedValue={groupe} onValueChange={(value: string) => setGroupe(value)}>
        <Picker.Item label="rachid" value="1st2" />
        <Picker.Item label="karim" value="1st1" />
        <Picker.Item label="samir" value="1st1" />
        <Picker.Item label="amin" value="1st1" />
